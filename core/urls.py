...
from .views import HomeView, PostView, CategoryView, SubCategoryView, TagView, PostListView, PostDetailView, CommentView
...
urlpatterns = [
    ...
    path('comment-create/', CommentView.as_view(), name='comment-create'),
]
